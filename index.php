                                        ...
                                        <div class="row flex-row-reverse align-items-center h-100">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="gen-movie-action">
                                                    <div class="gen-btn-container">
                                                        <a href="single-movie?course=<?= $video_id ?>&module=<?= $module ?>"
                                    ...
                                    <div class="gen-carousel-movies-style-2 movie-grid style-2">
                                        <div class="gen-movie-contain">
                                                ...
                                                <div class="gen-movie-add">
                                                    <div class="wpulike wpulike-heart">
                                                        <div class="wp_ulike_general_class wp_ulike_is_not_liked">
                                                            <button type="button"
                                                                ...
                                                                onclick="removeVid('<?= $user_address ?>','<?= $video_uuid ?>')"></button>
                                                        </div>
                                                    </div>
                                                    <ul class="menu bottomRight">
                                                        <li class="share top">
                                                            ...
                                                            <ul class="submenu">
                                                                <li><a href="https://www.facebook.com/sharer/sharer.php?u=<?= $post_link; ?>/single-movie?course=<?= $video_id ?>&module=<?= $module ?>&t=<?= $chapter_name;  ?>"
                                                                        class="facebook"
                                                        ...
                                                        <li><a href="https://www.linkedin.com/shareArticle?mini=true&url=<?= $post_link; ?>/single-movie?course=<?= $video_id ?>&module=<?= $module ?>&t=<?= $chapter_name;  ?>"
                                                                class="facebook"
                                                                onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
                                                        ...
                                                        <li><a href="https://twitter.com/share?url=<?= $post_link; ?>/single-movie?course=<?= $video_id ?>&module=<?= $module ?>&text=<?= $chapter_name;  ?>"
                                                                class="facebook"
                                                                onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
                                            ...
                                            <div class="gen-info-contain">
                                                <div class="gen-movie-info">
                                                    <h3><a
                                                            href="single-movie?course=<?= $video_id ?>&module=<?= $module ?>"><?= $chapter_name ?></a>
                                                    </h3>
                                                </div>
                                                <div class="gen-movie-meta-holder">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a
                                                                href="more-video?module=<?= $module ?>"><span><?= $module_name ?></span></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="gen-movie-add">
                                                    <div class="wpulike wpulike-heart">
                                                        <div class="wp_ulike_general_class wp_ulike_is_not_liked">
                                                            <button type="button"
                                                                class="wp_ulike_btn wp_ulike_put_image"
                                                                onclick="addFavourite('<?= $video_uuid ?>','<?= $user_address ?>')"></button>
                                                        </div>
                                                    </div>
                                                    <ul class="menu bottomRight">
                                                        <li class="share top">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="gen-movie-action">
                                                            <div class="gen-btn-container button-1">
                                                                <a class="gen-button"
                                                                    href="single-movie?course=<?= $video_id ?>&module=<?= $module ?>"
                                                                    tabindex="0">
