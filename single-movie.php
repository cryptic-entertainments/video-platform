...
if (isset($_GET['course']) && isset($_GET['module']) && ($_GET['module'] !== '') && ($_GET['module'] !== '')) {
      ...
      $result2 = mysqli_query($con, "SELECT * FROM `video_info` WHERE `video_uid` = '$course' AND `module_uuid` = '$module'");
         ...
         while ($row = mysqli_fetch_assoc($result2)) {        
               ...
               curl_setopt_array($curl, array(
                 ...
                 CURLOPT_HTTPHEADER => array(
                   'Authorization: Bearer 8920f388-12a1-4260-8ea9-112f6c1b4ca6'
                 ),
               ));   
                                ...
                                <div class="gen-video-holder">
                                    ...
                                    <div class="container p-0 setvideoSize">
                                        <a href="/" class="back_button"
                                            style="z-index: 888;position:absolute;padding:0.5rem;">
                                            <i class="fas fa-arrow-left"></i>
                                        </a>
                                        <video controls crossorigin playsinline poster="<?= $thumbnail2 ?>"
                                            id="myVideo">
                                            <source src="<?= $video_url ?>" type="video/mp4" size="576">
                                            <source src="<?= $video_url ?>" type="video/mp4" size="720">
                                            <source src="<?= $video_url ?>" type="video/mp4" size="1080">
                                        ...
                                        $query = "SELECT * FROM `video_info` WHERE `module_uuid`= '$module' order by Rand() limit 1";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {                                              
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    ?>
                                        <a href="single-movie?course=<?= $video_id_other ?>&module=<?= $module_other ?>"
                                            style="padding: 0.5rem 1rem;" class="btn btn-hover" id="setNextEpisode">Next
                                            Video</a>
                                        <?php }} ?>
                                    </div>
                                    ...
                                    <div class="gen-after-excerpt">
                                        ...
                                        <div class="gen-socail-share">
                                            ...
                                            <ul class="social-inner">
                                                <li><a href="https://www.facebook.com/sharer/sharer.php?u=<?= $post_link; ?>&t=<?= $title; ?>"
                                                        class="facebook"
                                                        onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
                                                        target="_blank" title="Share on Facebook"><i
                                                            class="fab fa-facebook-f"></i></a>
                                                </li>
                                                <li><a href="https://www.linkedin.com/shareArticle?mini=true&url=<?= $post_link; ?>&t=<?= $title; ?>"
                                                        class="facebook"
                                                        onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
                                                        target="_blank" title="Share on Linkedin"><i
                                                            class="fab fa-linkedin"></i></a>
                                                </li>
                                                <li><a href="https://twitter.com/share?url=<?= $post_link; ?>&text=<?= $title; ?>"
                                                        class="facebook"
                                                        onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
                                            ...
                                            <div class="col-lg-12" id="lets_hide">
                                                <div class="gen-load-more-button">
                                                    <div class="gen-btn-container">
                                                        <a class="gen-button gen-button-loadmore"
                                                            id="loadMore">
