...
if(isset($_SESSION['userAddress'])){
    ...
    if (isset($_POST['rowCount'])) {
        ...
        $query = mysqli_real_escape_string($con, $_POST['search_query']);    
            ...
            $queryData = "SELECT * FROM `video_info` WHERE `name` like '%$query%' OR `video_id` like '%$query%' OR `video_uid` like '%$query%' OR `module` like '%$query%' OR `video_desc` like '%$query%' limit $rowCount,$limitRow";
